...
export const Header = () => {
  ...
  return (
    <>
      <MobileHeader />
      <div className="fixed top-3 w-full z-10 px-4 md:block sm:hidden">
        <div className="mx-auto md:max-w-5xl grid grid-cols-1 md:grid-cols-[1fr_auto] items-center gap-3">
          <nav className="flex gap-1 p-0.5 border border-white/15 rounded-full bg-white/10 backdrop-blur mx-auto w-fit">
            <a
              href="#home"
              className={
                "nav-item " + (selected === "home" ? selectedStyle : "")
              }
          ...
          <div className="justify-self-center md:justify-self-end">
            <ContactTrigger className="absolute right-2 top-1/2 -translate-y-1/2 ml-4 inline-flex items-center justify-start px-6 py-1 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group">
